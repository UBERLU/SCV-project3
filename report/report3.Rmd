...
knitr::include_graphics('plots_report_thomas/chart_acquisition.png')
```
...
```{r echo=FALSE, out.width='60%'}
knitr::include_graphics('plots_report_thomas/confirmation_previous_citizenship.png')
```

```{r echo=FALSE, out.width='60%'}
knitr::include_graphics('plots_report_thomas/confirmation_age_gender.png')
```
...
```{r echo=FALSE, out.width='60%'}
knitr::include_graphics('plots_report_thomas/adoption_previous_citizenship.png')
```

```{r echo=FALSE, out.width='60%'}
knitr::include_graphics('plots_report_thomas/adoption_age_gender.png')
```
...
```{r echo=FALSE, out.width='60%'}
knitr::include_graphics('plots_report_thomas/reintegration_previous_citizenship.png')
```

```{r echo=FALSE, out.width='60%'}
knitr::include_graphics('plots_report_thomas/reintegration_age_gender.png')
```
...
```{r echo=FALSE, out.width='60%'}
knitr::include_graphics('plots_report_thomas/over_time_rein_adop_conf.png')
```
...
```{r echo=FALSE, out.width='60%'}
knitr::include_graphics('plots_report_thomas/ordin_simpl_previous_citizenship_percentage.png')
```

```{r echo=FALSE, out.width='60%'}
knitr::include_graphics('plots_report_thomas/ordin_simpl_previous_citizenship.png')
```

```{r echo=FALSE, out.width='60%'}
knitr::include_graphics('plots_report_thomas/ordin_simpl_proportion_previous_citizenship.png')
```

```{r echo=FALSE, out.width='60%'}
knitr::include_graphics('plots_report_thomas/ordin_simpl_age_gender.png')
```